<?php
	$adresa="Bow Wow Playground 400 W. St Charles Rd.Villa Park, IL  60181"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=6305011777;// Broj koji se poziva na dugme CALL US
